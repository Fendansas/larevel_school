...
//            $user->email = $code.'@test.ru';
    ...
    public function StudentRegPromotion($student_id){
        ...
        $editData = AssignStudent::with(['student', 'discount'])->where('student_id',$student_id)->first();
        return view('backend.student.student_reg.student_promotion', compact('years','classes','groups','shifts','editData'));
...
//            $user->email = $code.'@test.ru';
    ...
    public function StudentRegDetails($student_id){
        ...
        $pdf = PDF::loadView('backend.student.student_reg.student_details_pdf', compact('details'));

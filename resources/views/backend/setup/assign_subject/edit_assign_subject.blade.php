                                                    ...
                                                    <div class="controls">
                                                        <select name="class_id" required class="form-control">
                                                            ...
                                                            @foreach($classes as $class)
                                                                <option
                                                                    value="{{$class->id}}" {{($editData['0']->class_id == $class->id) ? "selected": ""}}  >
                                                                    {{$class->name}}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="text" value="{{$edit->full_mark}}" name="full_mark[]"
                                                                               class="form-control"
                                                                               required>
                                                                        @error('name')
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="text" value="{{$edit->pass_mark}}" name="pass_mark[]"
                                                                               class="form-control"
                                                                               required>
                                                                        @error('name')
                                                                        <span class="text-danger">{{$message}}</span>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <h5>Subjective Mark<span
                                                                            class="text-danger">*</span></h5>
                                                                    <div class="controls">
                                                                        <input type="text" value="{{$edit->subjective_mark}}" name="subjective_mark[]"
                                                                               class="form-control"
                                                                               required>
                                                                        @error('name')
                                                                        <span class="text-danger">{{$message}}</span>

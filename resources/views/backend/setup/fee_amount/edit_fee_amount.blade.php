            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form  method="post" action="{{ route('update.fee.amount', $editDate[0]->fee_category_id) }}" >
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                                    ...
                                                    <div class="controls">
                                                        <select name="fee_category_id" required class="form-control">
                                                            ...
                                                            @foreach($fee_categories as $category)
                                                                <option
                                                                    value="{{$category->id}}" {{ ($editDate['0']->fee_category_id ==$category->id) ? 'selected' : '' }}>{{$category->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>

                                                @foreach($editDate as $edit)
